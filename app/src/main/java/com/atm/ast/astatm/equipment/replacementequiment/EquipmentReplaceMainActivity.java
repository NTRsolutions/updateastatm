...
import com.atm.ast.astatm.equipment.EqupmentPagerAdapter;
...
public class EquipmentReplaceMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Add And Replace Equipment Info");
        loadView();
    ...
    protected void dataToView() {
        getArgs();
        getSharedPrefData();
        atmdbHelper = new ATMDBHelper(EquipmentReplaceMainActivity.this);
        ...
        mAdapter = new EqupmentReplacePagerAdapter(getSupportFragmentManager(), "");
