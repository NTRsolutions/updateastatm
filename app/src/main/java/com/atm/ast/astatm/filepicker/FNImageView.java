...
import com.atm.ast.astatm.utils.CircleTransform;
...
public class FNImageView extends AppCompatImageView {
	...
	public FNImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FNImageView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void init(AttributeSet attrs, int defStyleAttr) {
		...
		if (attrs != null) {
			TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FNImageView, defStyleAttr, 0);
			isCircular = a.getBoolean(R.styleable.FNImageView_isCircular, false);
			a.recycle();
		}
		this.file = null;
		this.uri = null;
