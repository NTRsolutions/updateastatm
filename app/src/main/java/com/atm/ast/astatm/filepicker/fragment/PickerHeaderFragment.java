...
import static com.atm.ast.astatm.utils.ASTObjectUtil.isEmptyStr;
...
public class PickerHeaderFragment extends HeaderFragment {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.cameraButton) {
            ...
            listener.rotateImage(FNCropImageView.RotateDegrees.ROTATE_M90D);
        } else if (v.getId() == R.id.btnRotateRight) {
            listener.rotateImage(FNCropImageView.RotateDegrees.ROTATE_90D);
