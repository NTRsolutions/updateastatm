...
import com.atm.ast.astatm.component.ASTAlertDialog;
import com.atm.ast.astatm.component.ASTErrorIndicator;
...
import static com.atm.ast.astatm.utils.ASTUtil.appNameWithoutSpace;
...
public class ASTUIUtil {
    ...
    public static void showErrorIndicator(Context context, String errorMsg, View belowOf) {
        if (ApplicationHelper.application().getActivity() != null && ApplicationHelper.application().getActivity().findViewById(R.id.errorIndicatorView) != null) {
            final LinearLayout errorIndicatorView = ApplicationHelper.application().getActivity().findViewById(R.id.errorIndicatorView);
            TextView errorMsgView = ApplicationHelper.application().getActivity().findViewById(R.id.error_msg);
            FontViewField closeButton = ApplicationHelper.application().getActivity().findViewById(R.id.closeErrorIndicator);
 ...
 /*   //chack run time EXTERNAL_STORAGE permission
    ...
    public static void SendMessage(Context context, String contact, String messageBody) {
    ...
    public static String[] concatinateStringArray(String[] a, String[] b) {
    ...
    public static void downloadapk(Context context, String apkName) {
        try {
    ...
    private static void installApk(Context context, String apkName) {
        try {
