...
import com.atm.ast.astatm.FNSortOrdering;
import com.atm.ast.astatm.FNSortOrderingUtil;
...
public class ASTUtil {
    ...
    public static PermissionRequestModel preparePermissionRequestModel(String permission, int requestCode, String msgForPermissionRationale, PermissionRationaleDialogListener listener, boolean isToShowRationale)
    {
        PermissionRequestModel permissionRequestModel = new PermissionRequestModel();
        permissionRequestModel.setListener(listener);
        permissionRequestModel.setMsgForPermissionRationale(msgForPermissionRationale);
        permissionRequestModel.setPermission(permission);
        permissionRequestModel.setRequestCode(requestCode);
        permissionRequestModel.setToShowRationale(isToShowRationale);
